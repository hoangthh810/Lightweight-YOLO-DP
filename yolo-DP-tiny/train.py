...
os.environ["WANDB_API_KEY"] ='a335a9d26e10e59ca5843c23ecf23bc721eca1cb'
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/weeds-LNJP.yaml', help='dataset.yaml path')
